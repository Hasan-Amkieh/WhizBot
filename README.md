WhizBot is a Whatsapp chatbot that supports the following commands: get prayer times in a specfic city, daily prayer reminders, get currency pair price, setting up alarms
